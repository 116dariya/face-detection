...
for y in range(0, w):
	for x in range(0, h):
		...
		if (((math.fabs(min_r - r)) < 20) and ((math.fabs(min_g - g)) < 20) and ((math.fabs(min_b-b)) <20)):
			...
			for y in range(index_y, w, 3):
				for x in range(0, h):
					if r == r1 and g == g1 and b == b1:
						...
						pix[x, y] = (r, g, b)
						print(index_y)
					if ((math.fabs(r1 - r) < 3) and (math.fabs(g1 - g) < 3) and (math.fabs(b1-b) <3)):
						r = 255
						g , b = 0
						pix[x, y] = (r, g, b)
						y = index_y1
